...
public class TestingPanel {
    ...
    private void loadTestPane() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/BSISJ7/TestCreator/questions/testPanels/" +
                panelName + ".fxml"));
        loader.setController(testPanels.get(questionIndex));
    ...
    public void returnToTestMenu(ActionEvent event) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            try {
                Parent testMenuPane = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/BSISJ7/TestCreator/MainMenu.fxml")));
